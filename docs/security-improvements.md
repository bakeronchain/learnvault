...
Implemented strict Cross-Origin Resource Sharing (CORS) policies to restrict API
access to authorized frontend domains only.
...
- **Credentials Support**: Enabled `credentials: true` for authenticated
  requests
