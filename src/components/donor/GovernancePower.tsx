...
export const GovernancePower: React.FC<GovernancePowerProps> = ({ balance, percentage }) => {
	...
	return (
		<section className="mb-20">
			<div className="flex items-center gap-4 mb-12">
				<h2 className="text-2xl font-black tracking-tight">{t("pages.donor.governancePower")}</h2>
				...
				<div className="glass-card p-10 rounded-[3rem] border border-white/5 relative overflow-hidden group">
					...
					<div className="flex items-baseline justify-between mb-6">
						<h3 className="text-sm text-white/40 uppercase font-black tracking-widest">
							{t("pages.donor.governanceTokenBalance")}
						</h3>
					...
					<p className="text-5xl font-black text-gradient mb-4">{balance.toLocaleString()}</p>
					<p className="text-xs text-white/40 font-medium">{t("pages.donor.govDescription")}</p>
				</div>
				...
				<div className="glass-card p-10 rounded-[3rem] border border-white/5 relative overflow-hidden group">
					...
					<div className="mb-6">
						<h3 className="text-sm text-white/40 uppercase font-black tracking-widest mb-4">
							{t("pages.donor.ofTotalSupply")}
						</h3>
						<div className="flex items-baseline gap-3">
							<p className={`text-5xl font-black ${getVisualization(percentage)}`}>
