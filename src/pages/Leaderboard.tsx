...
const Leaderboard: React.FC = () => {
	...
	return (
		<div className="p-4 sm:p-6 md:p-12 max-w-6xl mx-auto text-white animate-in fade-in slide-in-from-bottom-8 duration-1000">
			{/* Header */}
			<header className="mb-12 text-center">
				...
				<p className="text-white/40 text-base sm:text-lg font-medium">
			...
			{isLoading ? (
				...
				<div className="glass-card overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] border border-white/5 shadow-2xl">
					...
					<div className="p-4 sm:p-8 bg-white/5 border-t border-white/5 flex flex-col sm:flex-row gap-3 sm:gap-4 sm:justify-between sm:items-center">
